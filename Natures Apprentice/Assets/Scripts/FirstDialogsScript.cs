...
public class FirstDialogsScript : MonoBehaviour
{
    ...
    void ChangeText()
    {
        ...
        if (dialog == 1)
        {
            txtFirstDialog.text = "[Rasmus] Old man, I mean you no harm! I am Rasmus, my mother told me you wished to see me?";
        }
        else if (dialog == 2)
        {
            txtFirstDialog.text = "[Jaak] Hmm, yes. You look just like him.Dark hair, skinny, and of course appearing out of nowhere and scaring the bejesus out of me.Typical.";
        }
        else if (dialog == 3)
        {
            txtFirstDialog.text = "[Rasmus] Look like who?";
        }
        else if (dialog == 4)
        {
